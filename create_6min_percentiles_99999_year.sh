...
#cdo -yearpctl,99.99 full_array.nc -yearmin full_array.nc -yearmax full_array.nc 6min_perc_9999_year.nc
cdo -yearpctl,99.999 full_array.nc -yearmin full_array.nc -yearmax full_array.nc full_array_6min_perc_99999_year.nc
