...
#cdo -yyearpctl,99.0 full_array.nc -yyearmin full_array.nc -yyearmax full_array.nc 6min_perc_99_year.nc
...
cdo -yyearpctl,99.999 full_array.nc -yyearmin full_array.nc -yyearmax full_array.nc full_array_6min_perc_99999_year.nc
