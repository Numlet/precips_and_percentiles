...
sbatch --parsable --dependency=afterany:${partA_ID} create_6min_percentiles_fine.sh
...
sbatch --parsable --dependency=afterany:${partB_ID} create_12min_percentiles_fine.sh
