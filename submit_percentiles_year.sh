...
sbatch --parsable --dependency=afterany:${partA_ID} create_6min_percentiles_99_year.sh
sbatch --parsable --dependency=afterany:${partA_ID} create_6min_percentiles_999_year.sh
sbatch --parsable --dependency=afterany:${partA_ID} create_6min_percentiles_9999_year.sh
sbatch --parsable --dependency=afterany:${partA_ID} create_6min_percentiles_99999_year.sh
...
sbatch --parsable --dependency=afterany:${partB_ID} create_12min_percentiles_99_year.sh
sbatch --parsable --dependency=afterany:${partB_ID} create_12min_percentiles_999_year.sh
sbatch --parsable --dependency=afterany:${partB_ID} create_12min_percentiles_9999_year.sh
sbatch --parsable --dependency=afterany:${partB_ID} create_12min_percentiles_99999_year.sh
...
sbatch --parsable --dependency=afterany:${partB_ID} create_18min_percentiles_year.sh
sbatch --parsable --dependency=afterany:${partB_ID} create_18min_percentiles_fine_year.sh
...
sbatch --parsable --dependency=afterany:${partB_ID} create_24min_percentiles_year.sh
sbatch --parsable --dependency=afterany:${partB_ID} create_24min_percentiles_fine_year.sh
...
sbatch --parsable --dependency=afterany:${partB_ID} create_30min_percentiles_year.sh
sbatch --parsable --dependency=afterany:${partB_ID} create_30min_percentiles_fine_year.sh
...
sbatch --parsable --dependency=afterany:${partB_ID} create_60min_percentiles_year.sh
sbatch --parsable --dependency=afterany:${partB_ID} create_60min_percentiles_fine_year.sh
